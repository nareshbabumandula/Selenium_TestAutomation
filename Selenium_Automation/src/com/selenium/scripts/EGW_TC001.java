...
public class EGW_TC001 {
	...
	public void launchBrowser() {
		...
		try {
			...
			blnFindStore = driver.findElement(By.xpath("//button[contains(text(),'Find a Store')]")).isDisplayed();
			...
			if(blnFindStore){
				...
				test.log(LogStatus.FAIL, errMessage);
			}
			SoftAssert softassert = new SoftAssert();
			// soft assertion
			softassert.assertEquals(blnFindStore, true, "Find a Store option label is not displayed");
			// hard assertion
